...
<body id="verify-page">
    ...
    <div class="process container" style="margin: 0 auto;">
        <div class="row">
            <div class="quick-quote" style="margin:auto; width:50%;">
                ...
                <form id="quick-quote" method="post" action="/verify.php">
                  ...
                  <fieldset>
                      ...
                      <div>
                      <button type="submit" class="btn btn-warning">Get Quotes</button>
                      </div>
                  </fieldset> 
                </form>
            </div>
    ...
    <div class="footer" style="text-align:center; padding: 15px 0px;width:100%; background-color:#be1d20;">
       <p>Usurance, Inc.</p> 
    </div>
    </body>
</html>
