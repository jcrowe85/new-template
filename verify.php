        ...
        <div class="row">
            ...
            <form id="quick-quote" method="post" action="/cgi-bin/cqsl.cgi">
              ...
              <fieldset>
                  <div class='col-xs-12 col-md-12'>
                      ...
                      <div class="control-group">
                        <label class="control-text">
                          <select name="State">
                              <option style="background-color:#808080;" value="">Select State</option>
                              <option style="background-color:#808080;" value="1"  <?php if($State == "1") echo "selected"; ?> >Alabama</option>
                              <option style="background-color:#808080;" value="2"  <?php if($State == "2") echo "selected"; ?>>Alaska</option>
                              <option style="background-color:#808080;" value="3"  <?php if($State == "3") echo "selected"; ?>>Arizona</option>
                              <option style="background-color:#808080;" value="4"  <?php if($State == "4") echo "selected"; ?>>Arkansas</option>
                              <option style="background-color:#808080;" value="5"  <?php if($State == "5") echo "selected"; ?>>California</option>
                              <option style="background-color:#808080;" value="6"  <?php if($State == "6") echo "selected"; ?>>Colorado</option>
                              <option style="background-color:#808080;" value="7"  <?php if($State == "7") echo "selected"; ?>>Connecticut</option>
                              <option style="background-color:#808080;" value="8"  <?php if($State == "8") echo "selected"; ?>>Delaware</option>
                              <option style="background-color:#808080;" value="9"  <?php if($State == "9") echo "selected"; ?>>Dist.Columbia</option>
                              <option style="background-color:#808080;" value="10" <?php if($State == "10") echo "selected"; ?>>Florida</option>
                              <option style="background-color:#808080;" value="11" <?php if($State == "11") echo "selected"; ?>>Georgia</option>
                              <option style="background-color:#808080;" value="12" <?php if($State == "12") echo "selected"; ?>>Hawaii</option>
                              <option style="background-color:#808080;" value="13" <?php if($State == "13") echo "selected"; ?>>Idaho</option>
                              <option style="background-color:#808080;" value="14" <?php if($State == "14") echo "selected"; ?>>Illinois</option>
                              <option style="background-color:#808080;" value="15" <?php if($State == "15") echo "selected"; ?>>Indiana</option>
                              <option style="background-color:#808080;" value="16" <?php if($State == "16") echo "selected"; ?>>Iowa</option>
                              <option style="background-color:#808080;" value="17" <?php if($State == "17") echo "selected"; ?>>Kansas</option>
                              <option style="background-color:#808080;" value="18" <?php if($State == "18") echo "selected"; ?>>Kentucky</option>
                              <option style="background-color:#808080;" value="19" <?php if($State == "19") echo "selected"; ?>>Louisiana</option>
                              <option style="background-color:#808080;" value="20" <?php if($State == "20") echo "selected"; ?>>Maine</option>
                              <option style="background-color:#808080;" value="21" <?php if($State == "21") echo "selected"; ?>>Maryland</option>
                              <option style="background-color:#808080;" value="22" <?php if($State == "22") echo "selected"; ?>>Massachusetts</option>
                              <option style="background-color:#808080;" value="23" <?php if($State == "23") echo "selected"; ?>>Michigan</option>
                              <option style="background-color:#808080;" value="24" <?php if($State == "24") echo "selected"; ?>>Minnesota</option>
                              <option style="background-color:#808080;" value="25" <?php if($State == "25") echo "selected"; ?>>Mississippi</option>
                              <option style="background-color:#808080;" value="26" <?php if($State == "26") echo "selected"; ?>>Missouri</option>
                              <option style="background-color:#808080;" value="27" <?php if($State == "27") echo "selected"; ?>>Montana</option>
                              <option style="background-color:#808080;" value="28" <?php if($State == "28") echo "selected"; ?>>Nebraska</option>
                              <option style="background-color:#808080;" value="29" <?php if($State == "29") echo "selected"; ?>>Nevada</option>
                              <option style="background-color:#808080;" value="30" <?php if($State == "30") echo "selected"; ?>>New Hampshire</option>
                              <option style="background-color:#808080;" value="31" <?php if($State == "31") echo "selected"; ?>>New Jersey</option>
                              <option style="background-color:#808080;" value="32" <?php if($State == "32") echo "selected"; ?>>New Mexico</option>
                              <option style="background-color:#808080;" value="52" <?php if($State == "52") echo "selected"; ?>>NY Non-Bus</option>
                              <option style="background-color:#808080;" value="33" <?php if($State == "33") echo "selected"; ?>>NY Business</option>
                              <option style="background-color:#808080;" value="34" <?php if($State == "34") echo "selected"; ?>>North Carolina</option>
                              <option style="background-color:#808080;" value="35" <?php if($State == "35") echo "selected"; ?>>North Dakota</option>
                              <option style="background-color:#808080;" value="36" <?php if($State == "36") echo "selected"; ?>>Ohio</option>
                              <option style="background-color:#808080;" value="37" <?php if($State == "37") echo "selected"; ?>>Oklahoma</option>
                              <option style="background-color:#808080;" value="38" <?php if($State == "38") echo "selected"; ?>>Oregon</option>
                              <option style="background-color:#808080;" value="39" <?php if($State == "39") echo "selected"; ?>>Pennsylvania</option>
                              <option style="background-color:#808080;" value="40" <?php if($State == "40") echo "selected"; ?>>Rhode Island</option>
                              <option style="background-color:#808080;" value="41" <?php if($State == "41") echo "selected"; ?>>South Carolina</option>
                              <option style="background-color:#808080;" value="42" <?php if($State == "42") echo "selected"; ?>>South Dakota</option>
                              <option style="background-color:#808080;" value="43" <?php if($State == "43") echo "selected"; ?>>Tennessee</option>
                              <option style="background-color:#808080;" value="44" <?php if($State == "44") echo "selected"; ?>>Texas</option>
                              <option style="background-color:#808080;" value="45" <?php if($State == "45") echo "selected"; ?>>Utah</option>
                              <option style="background-color:#808080;" value="46" <?php if($State == "46") echo "selected"; ?>>Vermont</option>
                              <option style="background-color:#808080;" value="47" <?php if($State == "47") echo "selected"; ?>>Virginia</option>
                              <option style="background-color:#808080;" value="48" <?php if($State == "48") echo "selected"; ?>>Washington</option>
                              <option style="background-color:#808080;" value="49" <?php if($State == "49") echo "selected"; ?>>West Virginia</option>
                              <option style="background-color:#808080;" value="50" <?php if($State == "50") echo "selected"; ?>>Wisconsin</option>
                              <option style="background-color:#808080;" value="51" <?php if($State == "51") echo "selected"; ?>>Wyoming</option>
                              <option style="background-color:#808080;" value="53" <?php if($State == "53") echo "selected"; ?>>Guam</option>
                              <option style="background-color:#808080;" value="54" <?php if($State == "54") echo "selected"; ?>>Puerto Rico</option>
                              <option style="background-color:#808080;" value="55" <?php if($State == "55") echo "selected"; ?>>Virgin Islands</option>
                              <option style="background-color:#808080;" value="56" <?php if($State == "56") echo "selected"; ?>>Amer. Samoa</option>
                          </select>
                      </div>
                  </div>                  
                  <!--<div class='row visible-xs'>-->
              ...
              <fieldset>
                  ...
                  <!--<div class='row visible-xs'>-->
                  <!--    <div class='col-xs-12 col-sm-4'>-->
                  <!--        <h1 style="width: 100%">Do you use nicotine?</h1>-->
                  <!--    </div>-->
                  <!--    <div class='col-xs-12 col-sm-4'>-->
                  <!--        <div class="control-group">-->
                  <!--            <label class="control control--checkbox">-->
              ...
              <fieldset>
                      ...
                      <div class="control-group">
                          <label class="control-text">
                            <select name="FaceAmount" id="faceamount">
                                ...
                                <option style="background-color:#808080;" value="150000" <?php if($FaceAmount == "150000") echo "selected"; ?>>$150,000</option>
                                <option style="background-color:#808080;" value="175000" <?php if($FaceAmount == "175000") echo "selected"; ?>>$175,000</option>
                                <option style="background-color:#808080;" value="200000" <?php if($FaceAmount == "200000") echo "selected"; ?>>$200,000</option>
                                <option style="background-color:#808080;" value="225000" <?php if($FaceAmount == "225000") echo "selected"; ?>>$225,000</option>
                                <option style="background-color:#808080;" value="250000" <?php if($FaceAmount == "250000") echo "selected"; ?>>$250,000</option>
                                <option style="background-color:#808080;" value="300000" <?php if($FaceAmount == "300000") echo "selected"; ?>>$300,000</option>
                                <option style="background-color:#808080;" value="350000" <?php if($FaceAmount == "350000") echo "selected"; ?>>$350,000</option>
                                <option style="background-color:#808080;" value="400000" <?php if($FaceAmount == "400000") echo "selected"; ?>>$400,000</option>
                                <option style="background-color:#808080;" value="450000" <?php if($FaceAmount == "450000") echo "selected"; ?>>$450,000</option>
                                <option style="background-color:#808080;" value="500000" <?php if($FaceAmount == "500000") echo "selected"; ?>>$500,000</option>
                                <option style="background-color:#808080;" value="550000" <?php if($FaceAmount == "550000") echo "selected"; ?>>$550,000</option>
                                <option style="background-color:#808080;" value="600000" <?php if($FaceAmount == "600000") echo "selected"; ?>>$600,000</option>
                                <option style="background-color:#808080;" value="650000" <?php if($FaceAmount == "650000") echo "selected"; ?>>$650,000</option>
                                <option style="background-color:#808080;" value="700000" <?php if($FaceAmount == "700000") echo "selected"; ?>>$700,000</option>
                                <option style="background-color:#808080;" value="750000" <?php if($FaceAmount == "750000") echo "selected"; ?>>$750,000</option>
                                <option style="background-color:#808080;" value="800000" <?php if($FaceAmount == "800000") echo "selected"; ?>>$800,000</option>
                                <option style="background-color:#808080;" value="900000" <?php if($FaceAmount == "900000") echo "selected"; ?>>$900,000</option>
                                <option style="background-color:#808080;" value="1000000" <?php if($FaceAmount == "1000000") echo "selected"; ?>>$1,000,000</option>
                                <option style="background-color:#808080;" value="1100000" <?php if($FaceAmount == "1100000") echo "selected"; ?>>$1,100,000</option>
                                <option style="background-color:#808080;" value="1250000" <?php if($FaceAmount == "1250000") echo "selected"; ?>>$1,250,000</option>
                      ...
                      <div class="control-group">
                          <label class="control-text">
                            <select name="NewCategory" class="">
                                <option style="background-color:#808080;" value="2" <?php if($NewCategory == "2") echo "selected"; ?> >5-Year Term</option>
                                <option style="background-color:#808080;" value="3" <?php if($NewCategory == "3") echo "selected"; ?> >10-Year Term</option>
                                <option style="background-color:#808080;" value="4" <?php if($NewCategory == "4") echo "selected"; ?> >15-Year Term</option>
                                <option style="background-color:#808080;" value="5" <?php if($NewCategory == "5") echo "selected"; ?> >20-Year Term</option>
                                <option style="background-color:#808080;" value="6" <?php if($NewCategory == "6") echo "selected"; ?> >25-Year Term</option>
                                <option style="background-color:#808080;" value="7" <?php if($NewCategory == "7") echo "selected"; ?> >30-Year Term</option>
                                <option style="background-color:#808080;" value="9" <?php if($NewCategory == "9") echo "selected"; ?> >35-Year Term</option>                                
                            </select> 
                          </label>
                      </div>
                  </div>                  
                  <!--<div class='row visible-xs'>-->
                  <!--    <div class='col-xs-12 col-sm-4'>-->
                  <!--        <h1 style="width: 100%">How much/ How long?</h1>-->
                  <!--    </div>-->
                  <!--    <div class='col-xs-12 col-sm-4'>-->
                  <!--         <div class="control-group">-->
                  <!--            <label class="control-text">-->
